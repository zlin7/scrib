...
if __name__ == '__main__':
    ...
    test(lambda: qs.loss_class_specific_py(pred, labels_py, max_classes, rks, **loss_kwargs),
         lambda: qs.loss_class_specific(idx2rnk, scores_idx, labels, max_classes, ps, rks, **loss_kwargs),
    ...
    test(lambda: qs.naive_coord_descnet_class_specific_py(out, scores, scores_idx, labels, ps, rks, class_weights=False, **loss_kwargs),
         lambda: qs.main_coord_descent_class_specific(idx2rnk, scores_idx, labels, max_classes, ps, rks, class_weights=None, **loss_kwargs),
    ...
    test(lambda: qs.naive_coord_descnet_overall_py(out, scores, scores_idx, labels, ps, 0.3, **loss_kwargs),
         lambda: qs.main_coord_descent_overall(idx2rnk, scores_idx, labels, max_classes, ps, 0.3, **loss_kwargs),
